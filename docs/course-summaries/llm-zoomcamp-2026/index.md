...
| 4.12 Generating RAG Answers                   | [4-12 Generating RAG Answers](#4-12-generating-rag-answers)                                     |                                                                                         |
...
To evaluate the RAG pipeline end-to-end, we compare the answer generated by RAG to the ground truth answer

**Loading the FAQ data and creating a lookup table for the answers**
...
- Once we have the RAG answers and ground truth answers, we can pass them to an LLM judge
- It is another LLM that compares the question, ground truth answer and the RAG answer

**Define the output format for LLM Judge**
...
**Define instructions and prompt template for LLM judge**
...
**Prompting the judge for evaluation**
