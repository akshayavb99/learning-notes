    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;border-bottom:0.5px solid var(--pd-border)">
      <div style="padding:14px 18px;border-right:0.5px solid var(--pd-border)">
        ...
        <svg viewBox="0 -12 200 75" xmlns="http://www.w3.org/2000/svg"
          ...
          <rect x="0" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="15" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="30" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="45" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="60" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="75" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="90" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="105" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="120" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="135" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="150" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="165" y="38" width="12" height="2" rx="2" fill="#3b82f6" opacity="0.20"/>
<rect x="180" y="0" width="12" height="40" rx="2" fill="#3b82f6" opacity="1.00"/>
          <text x="6" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">Feb</text>
<text x="51" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">Mar</text>
<text x="126" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">Apr</text>
<text x="186" y="-3" text-anchor="middle" font-size="7" font-weight="500" fill="#3b82f6" font-family="monospace">4</text>
<text x="186" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">May</text>
        </svg>
        <div class="pd-sec-title" style="margin-bottom:6px">Top tags</div>
        <div style="display:flex;flex-wrap:wrap;gap:4px"><span class="tag tag-t">dsa</span><span class="tag tag-t">interview-preparation</span><span class="tag tag-t">git</span><span class="tag tag-t">github</span><span class="tag tag-t">version-control</span><span class="tag tag-t">best-practices</span></div>
      </div>
  ...
  <div class="pd-footer">
    <a href="concept-notes/">View All →</a>
  </div>
</div>
<!-- pd-cn:end -->
...
<text x="186" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">May</text>
        ...
        <div class="pd-sec-title" style="margin-bottom:6px">Top tags</div>
        <div style="display:flex;flex-wrap:wrap;gap:4px"><span class="tag tag-t">index</span><span class="tag tag-t">artificial-intelligence</span><span class="tag tag-t">system-design</span></div>
      </div>
      <div style="padding:14px 18px">
        <div class="pd-sec-title">Recent</div>
        <ul class="prob-list">
...
<text x="51" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">Mar</text>
<text x="126" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">Apr</text>
<text x="186" y="-3" text-anchor="middle" font-size="7" font-weight="500" fill="#3b82f6" font-family="monospace">1</text>
<text x="186" y="54" text-anchor="middle" font-size="7" style="fill: var(--pd-muted);" font-family="monospace">May</text>
        </svg>
        <div class="pd-sec-title" style="margin-bottom:6px">Top tags</div>
  ...
  <div class="pd-footer">
    <a href="book-summaries/">View All →</a>
  </div>
</div>
<!-- pd-bs:end -->
